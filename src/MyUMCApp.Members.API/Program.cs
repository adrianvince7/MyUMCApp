...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "MyUMC Members API", Version = "v1" });
...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
    options.UseMySql(
        ...
        b => b.MigrationsAssembly("MyUMCApp.Members.API")
    ));
...
try
{
    Log.Information("Starting MyUMC Members API");
    app.Run();
}
catch (Exception ex)
{
